...
import DA from "../almabetter resoures/DA 2.png";
import { toast } from "react-toastify";

export default function DACourse() {
  ...
  return (
    <div className="container-fluid" style={styles.courseContainer}>
      <div className="container py-4">
        <div className="row g-4">
          ...
          <div className="col-lg-6">
            ...
            >
              <h1 style={styles.heading}>Training In Data Analytics</h1>
            ...
            >
              <img src={DA} alt="Data Analytics" style={{ width: "100%" }} />
            </div>
          </div>
        ...
        <div style={styles.infoSection}>
          <div className="row text-center g-0" style={styles.infoSectionRow}>
            <div className="col-md-3 p-3" style={styles.infoColumn}>
            ...
            <div className="col-md-3 p-3" style={styles.infoColumnLast}>
